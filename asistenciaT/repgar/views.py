...
def Buscar(request):
    if 'q' in request.GET and request.GET['q']:
        ...
        #return HttpResponse ('<body style="background-color:#262726" ><center><h1>Busqueda Fallida</h1><br><p >Es posible que los datos que intenta Buscar pueden estar erroneo o <em>(Serial)</em> Invalidao</p><br><a href="/registro/ %}">Regresar</a></a></center></body></html>')
        return render_to_response('registro/busquedafallida.html', locals())
...
def gracias(request):
    html='<!DOCTYPE html><html><head><title>Gracias SSAS</title><body><center><h1>Gracias por enviarnos su comentarios XD</h1></div></div></div></center></body></html>'
    return HttpResponse(html)
